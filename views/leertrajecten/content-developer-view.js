    ...
    render() {
        ...
        <article-element>
            ...
            <span slot="col-2">
                ...
                To be successful as a Content Developer, you should have great communication, research, and teamwork skills. Ultimately, a top-notch Content Developer has a good working knowledge of content management software as well as a basic knowledge of HTML and an eye for detail.            </span>
        </article-element>
        <article-element>
            <span slot="header">Wat kan een content developer</span>
            <span slot="col-1">
                <h3>Welke verantwoordelijkheden heeft een content developer</h3>
                Coming up with content goals and strategies and pitching ideas to the Marketing and Communications Directors. Collaborating with other departments and team members and brainstorming subjects for creative content.
...
Analyzing performance indicators and web traffic and determining the effectiveness of created content.            </span>
            <span slot="col-2">
...
Ability to work independently and as part of a team.
        ...
        <course-element video="4" onderwerpen="2" projecten="6" src="img/courses/course_html5.svg" href="/course-html5">
            <span slot="title">Beginnerscursus HTML5</span>
